...
Bond::Bond(int bond_id, int origin_atom_id, int target_atom_id, string bond_type, string status_bits) {
...
string Bond::toString() {
    std::stringstream ss;
    ss << this->bond_id << ":[" << this->origin_atom_id << " -> " << this->target_atom_id << "] "<< this->bond_type;
    std::string s = ss.str();
    return s;
}
