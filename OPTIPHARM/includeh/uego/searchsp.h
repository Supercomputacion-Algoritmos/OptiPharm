...
public:
	...
	virtual double	PreciseUpdateValue() { return ( value = Value() ); };// No optimization in objective function
	...
	// random element in area given by center and radius index
		virtual SearchSpElement* generateMutationNew( short, SearchSpElement* s=NULL )=0;
