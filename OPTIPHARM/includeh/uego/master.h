...
public:
	...
	void PrintList();
	/**
	 * Guarda la lista de especies actual en un archivo. Ademas indica el nivel en el que se encuentra
	 */
	void SaveListFile(int level, string file, string step);

	/*
	 * Crea una captura de pantalla de todos los compuestos de la lista de soluciones actual.
	 * Para ello hace uso del programa Pymol. En esta ocasion se esta utilizando la version 2.2
	 */
