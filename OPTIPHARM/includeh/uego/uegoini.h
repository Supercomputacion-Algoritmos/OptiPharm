...
public:
	void setLevelMaster(short level_tem){
		level_actual = level_tem;
	}
	short getLevelMaster(){
		return level_actual;
	}
	Ini(FILE*);
	...
	Molecule* getMolQuery() {
		return molQuery;
	}

	void setPathMolQuery(string path) {
		this->pathFileMolQuery = path;
	}

	void setPathMolVariable(string path) {
		this->pathFileMolVariable = path;
	}

	string getPathMolQuery() {
		return this->pathFileMolQuery;
	}

	string getPathMolVariable() {
		return this->pathFileMolVariable;
	}

	Molecule* getMolVariable() {
		return molVariable;
	}
	...
	string getNameFileMolQuery() {
		return this->nameFileMolQuery;
	}

	void setNameFileMolQuery(string name) {
		this->nameFileMolQuery = name;
	}

	string getNameFileMolVariable() {
		return this->nameFileMolVariable;
	}

	void setNameFileMolVariable(string name) {
		this->nameFileMolVariable = name;
	}
	...
	void setPathOutputFiles(string path) {
		this->pathOutputFiles = path;
	}

	bool getSameVanDerWaalsRadius() {
		return this->sameVanDerWaalsRadius;
	}

	void setSameVanDerWaals(bool same) {
		this->sameVanDerWaalsRadius = same;
	}

	bool getConsiderHydrogens() {
		return this->considerHydrogens;
	}
	...
	bool getSaveSolutionMol2Files() {
		return this->saveSolutionMol2Files;
	}
	void setSaveSolutionMol2Files(bool save) {
		this->saveSolutionMol2Files = save;
	}

	string getPathMolTemp() {
		return this->pathFileMolTemp;
	}
	void setPathMolTemp(string path) {
		this->pathFileMolTemp = path;
	}
	/**
	 * Update r, evals, newspeciesevals vector and threshold value. It is necessary because after to obtain the value for each molecule,
	 * these values are calculated with automatic process.
	 */
	...
	void setEvals(unsigned long *newEvals) {
		this->evals = newEvals;
	}
	...
	void setFailFlag(char newFailFlag) {
		this->FailFlag = newFailFlag;
	}
	...
	void setLastR(double newLastR) {
		this->last_r = newLastR;
	}

	void setLowLimit(double newLowLimit) {
		this->lowLimit = newLowLimit;
	}
	double getLowLimit() {
		return this->lowLimit;
	}

	Molecule* getMoleculeTemp() {
		return this->molTemp;
	}
	...
	void setExecutableName(string name) {
		this->name_executable = name;
	}
	string getExecutableName() {
		return name_executable;
	}
	void setMolQueryToString(string query) {
		this->MolQueryToString = query;
	}
	string getMolQueryToString() {
		return MolQueryToString;
	}
};
